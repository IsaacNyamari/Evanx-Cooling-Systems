                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item">
                        ...
                        <div class="d-flex align-items-center bg-light">
                            ...
                            <a class="h4 mx-4 mb-0" href="ac-installation.php">AC Installation</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item">
                        ...
                        <div class="d-flex align-items-center bg-light">
                            ...
                            <a class="h4 mx-4 mb-0" href="cooling-services.php">Cooling Services</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item">
                        ...
                        <div class="d-flex align-items-center bg-light">
                            ...
                            <a class="h4 mx-4 mb-0" href="heating-services.php">Heating Services</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item">
                        ...
                        <div class="d-flex align-items-center bg-light">
                            ...
                            <a class="h4 mx-4 mb-0" href="maintenance.php">Maintenance & Repair</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item">
                        ...
                        <div class="d-flex align-items-center bg-light">
                            ...
                            <a class="h4 mx-4 mb-0" href="indoor-air-quality.php">Indoor Air Quality</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item">
                        ...
                        <div class="d-flex align-items-center bg-light">
                            ...
                            <a class="h4 mx-4 mb-0" href="annual-inspection.php">Annual Inspections</a>
                        </div>
                    </div>
                </div>
            </div>
