<div class="container-fluid overflow-hidden my-5 px-lg-0">
    <div class="container quote px-lg-0">
        <div class="row g-0 mx-lg-0">
            <div class="col-lg-12 quote-text" data-parallax="scroll" data-image-src="img/03/WhatsApp-Image-2024-02-20-at-12.13.59-590x550-1.jpeg">
                <div class="h-100 px-4 px-sm-5 ps-lg-0 wow fadeIn" data-wow-delay="0.1s">
                    <h1 class="text-white mb-4">For Individuals And Organisations</h1>
                    <p class="text-light mb-5">
                        Evanx Cooling System delivers reliable, high-performance cooling solutions tailored to meet unique needs. Whether it's a small residential setup or a large-scale commercial project, we offer personalized services that prioritize comfort, energy efficiency, and long-term value. Our team works closely with clients to design, install, and maintain systems that keep environments perfectly cool <br> — ensuring smooth operations for businesses and comfortable spaces for families.
                    </p>
                    <a href="service.php" class="align-self-start btn btn-primary py-3 px-5">More Details</a>
                </div>
            </div>
